...
public class Crypt2 {
    ...
    public static void main(String[] args) throws Exception {
        Crypt2 cr2 = new Crypt2();
        String pass = "admin";
        System.out.println(pass);
        //cr2.genKeyPair(512);
        String file_private = "C:\\Users\\PC\\Documents\\rsa.pri";
        String file_public = "C:\\Users\\PC\\Documents\\rsapublic.pri";
        cr2.saveToDiskPrivateKey(file_private);
        cr2.saveToDiskPublicKey(file_public);
        String secure = cr2.Encrypt(pass);
